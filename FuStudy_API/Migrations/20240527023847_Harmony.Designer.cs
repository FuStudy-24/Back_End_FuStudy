...
namespace FuStudy_API.Migrations
{
    ...
    [Migration("20240527023847_Harmony")]
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 5, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(7197),
                            Image = "ahihi",
                            TotalLike = 1,
                            UserId = 2L
                        });
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.BlogComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BlogId = 1L,
                            Comment = "Great post!",
                            CreateDate = new DateTime(2024, 5, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(7223),
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Conversation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateAt = new DateTime(2024, 5, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(7408),
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.ConversationMessage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Content = "Hello!",
                            ConversationId = 1L,
                            CreateTime = new DateTime(2024, 5, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(7424),
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.MessageReaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(7463),
                            ReactionType = "like",
                            UserId = 2L
                        });
                });
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2024, 5, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(7181),
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Question", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 5, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(6914),
                            Image = "ahihi",
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = false,
                            StudentId = 1L,
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.QuestionComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 5, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(7377),
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            QuestionId = 1L,
                            Status = false,
                            UserId = 2L
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.StudentSubcription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CurrentQuestion = 0,
                            EndDate = new DateTime(2024, 6, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(7041),
                            LimitQuestion = 10,
                            StartDate = new DateTime(2024, 5, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(7040),
                            Status = true,
                            StudentId = 1L,
                            SubcriptionId = 1L
                        });
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 5, 27, 9, 38, 46, 932, DateTimeKind.Local).AddTicks(7118),
