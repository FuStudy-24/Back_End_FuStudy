    ...
    public partial class yourMigrationName : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "How to be a better mentor", new DateTime(2024, 5, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7740), "ahihi", 2L });

            migrationBuilder.InsertData(
                table: "Conversation",
                columns: new[] { "Id", "CreateAt", "Duration", "EndTime", "IsClose", "LastMessage", "User1Id", "User2Id" },
                values: new object[] { 1L, new DateTime(2024, 5, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7860), new TimeSpan(0, 0, 0, 0, 0), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, "Hello!", 1L, 2L });

            migrationBuilder.InsertData(
                table: "Mentor",
                columns: new[] { "Id", "AcademicLevel", "OnlineStatus", "Skill", "UserId", "Video", "WorkPlace" },
                values: new object[] { 1L, "Master's", "offline", "Ahihi", 3L, "ahihi", "Tech Company" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, "Great post!", new DateTime(2024, 5, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7810), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 1L });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "Hello!", 1L, new DateTime(2024, 5, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7880), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, false, 1L });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2024, 5, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7700), "Payment for Basic subscription", 9.9900000000000002, "PAY12345", true, 1L, 1L });

            migrationBuilder.InsertData(
                table: "Question",
                columns: new[] { "Id", "CategoryId", "Content", "CreateDate", "Image", "ModifiedDate", "Status", "StudentId" },
                values: new object[] { 1L, 1L, "How to sort an array in C#?", new DateTime(2024, 5, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7500), "ahihi", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 1L });

            migrationBuilder.InsertData(
                table: "StudentSubcription",
                columns: new[] { "Id", "CurrentQuestion", "EndDate", "LimitQuestion", "StartDate", "StudentId", "SubcriptionId" },
                values: new object[] { 1L, 0, new DateTime(2024, 6, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7680), 10, new DateTime(2024, 5, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7680), 1L, 1L });

            migrationBuilder.InsertData(
                table: "Transaction",
                columns: new[] { "Id", "Ammount", "CreateTime", "Description", "Type", "WalletId" },
                values: new object[] { 1L, -9.9900000000000002, new DateTime(2024, 5, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7730), "Subscription payment", "Payment", 1L });

            migrationBuilder.InsertData(
                table: "MessageReaction",
                columns: new[] { "Id", "ConversationMessageId", "CreateAt", "ReactionType", "UserId" },
                values: new object[] { 1L, 1L, new DateTime(2024, 5, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7900), "like", 2L });

            migrationBuilder.InsertData(
                table: "QuestionComment",
                columns: new[] { "Id", "Content", "CreateDate", "ModifiedDate", "QuestionId", "Status", "UserId" },
                values: new object[] { 1L, "Good question!", new DateTime(2024, 5, 24, 2, 8, 2, 21, DateTimeKind.Local).AddTicks(7840), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1L, false, 2L });
