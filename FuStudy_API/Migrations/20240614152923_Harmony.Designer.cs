...
namespace FuStudy_API.Migrations
{
    ...
    [Migration("20240614152923_Harmony")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(2951),
                            Image = "ahihi",
                            TotalLike = 1,
                            UserId = 2L
                        });
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.BlogComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BlogId = 1L,
                            Comment = "Great post!",
                            CreateDate = new DateTime(2024, 6, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(2971),
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Conversation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateAt = new DateTime(2024, 6, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(3068),
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.ConversationMessage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Content = "Hello!",
                            ConversationId = 1L,
                            CreateTime = new DateTime(2024, 6, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(3088),
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.MessageReaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(3121),
                            ReactionType = "like",
                            UserId = 2L
                        });
                });
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateDate = new DateTime(2024, 6, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(2942),
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Question", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(2693),
                            Image = "ahihi",
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = false,
                            StudentId = 1L,
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.QuestionComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(3039),
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            QuestionId = 1L,
                            Status = false,
                            UserId = 2L
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.StudentSubcription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CurrentMeeting = 0,
                            CurrentQuestion = 0,
                            EndDate = new DateTime(2024, 7, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(2773),
                            StartDate = new DateTime(2024, 6, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(2772),
                            Status = true,
                            StudentId = 1L,
                            SubcriptionId = 1L
                        });
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Token", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FuStudy_Repository.Entity.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2024, 6, 14, 22, 29, 22, 961, DateTimeKind.Local).AddTicks(2873),
